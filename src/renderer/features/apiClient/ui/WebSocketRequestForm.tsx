...
export const WebSocketRequestForm: React.FC = () => {
  ...
  return (
    <ApiWorkspace
      ...
      historyEmptyLabel="Connections appear here"
    >
      <div className="ws-workspace">
        <div className="ws-workspace__controls">
          <div className="request-bar">
            <input
              type="text"
              className={`request-bar__url${wsUrlError ? ' input--error' : ''}`}
        ...
        <div className="ws-workspace__messages">
          {wsConnected ? (
            <>
              ...
              <section className="api-form-section ws-messages-section">
                <div className="ws-messages-section__head">
            ...
            <p className="ws-workspace__placeholder">
